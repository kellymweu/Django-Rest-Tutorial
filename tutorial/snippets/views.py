...
def snippet_detail(request, pk, format=None):
    #Retrieve, update or delete a codesnippet.
...
#Rewrite API using class_base views, makes for better http method separation
...
#Using Mixed in Generic Class based Views
